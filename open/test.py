...
# Define the path to the folder for saving photos on the desktop
output_folder = os.path.join(home_directory, "Desktop", "pozetest")
        ...
        if cv2.contourArea(c) > 0:
            ...
            if radius > 10:
                ...
                if distance_to_center < 10:
                    ...
                    # Generate a unique filename for the photo in the "pozetest" folder on the desktop
